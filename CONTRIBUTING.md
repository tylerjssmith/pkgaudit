...
worth flagging, or a revision to one that already exists.
...
pkgaudit aims for **precision above 0.95** and **prevalence below
0.05**, so that a finding is worth a reviewer’s attention. A rule that
