# the document has the shape a consumer is promised
    ...
    Output
      ...
      runs[].artifacts[].properties.bytes
      runs[].artifacts[].properties.language
      runs[].artifacts[].properties.lines
      runs[].artifacts[].properties.reason
      runs[].artifacts[].properties.status
      runs[].invocations[].executionSuccessful
      runs[].invocations[].toolExecutionNotifications[].descriptor.id
      ...
      runs[].results[].properties.phases[]
      runs[].results[].ruleId
