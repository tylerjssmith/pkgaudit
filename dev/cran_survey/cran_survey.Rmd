...
functions used to summarize the results. The first function summarizes findings
as proportions of findings; the second function summarizes findings as
proportions of packages.
...
downloaded package, providing empirical support for the defaults implemented in
`validate_tarball()`.
