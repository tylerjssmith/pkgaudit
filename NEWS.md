...
* New vignette, "Understanding pkgaudit Rules", which walks through one rule
  from each category -- a file context, a code context, and a pattern -- and
  shows how its fields decide what it matches.
