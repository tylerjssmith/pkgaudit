...
#'
#' Finds matches -- regular-expression matches in code R hands to a shell or to
#' make, whether it is a file (e.g., `configure`, `src/Makevars`) or a shell
#' chunk in a vignette.
#'
